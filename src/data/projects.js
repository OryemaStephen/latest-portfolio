...
const projects = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Built role-based access control and financial-period transaction locking",
  ...
  },
  {
    ...
    description:
      "A content publishing platform that lets educators and creators publish and monetize their work.",
    highlights: [
      "Built a full-stack CMS with a React frontend, Node.js/Express backend and PostgreSQL database",
      ...
      "Set up Nodemailer for registration and notification emails",
      "Built an analytics dashboard to track content performance",
      "Added sharing to X, LinkedIn and WhatsApp",
    ],
    tags: ["React", "Tailwind CSS", "Node.js", "Express.js", "PostgreSQL", "Stripe", "Flutterwave", "OpenAI"],
    challenge:
  ...
  {
    title: "Jeba Pesa",
    company: "Jeba Pesa Uganda",
    role: "Software Developer",
    image: jebapesa,
    live: "https://jebapesa.com",
    description:
      "A digital financial cooperative platform for community savings, cash rounds and collective giving.",
    highlights: [
      "Built a smooth, approachable interface for everyday financial workflows",
      "Developed crowdfunding, cash round and SACCO modules",
      "Created an admin portal to manage members and platform activity",
      "Optimized for SEO and performance (98+ Lighthouse score)",
      "Added SMS notifications for registrations and transaction alerts",
    ],
